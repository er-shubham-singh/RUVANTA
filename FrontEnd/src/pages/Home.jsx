        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="text-4xl md:text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">
                25+
              </div>
              <div className="text-xs md:text-sm font-semibold tracking-wider text-gray-500 dark:text-gray-400 uppercase mt-2">
                Projects Designed
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {courses.map((course, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/50 shadow-sm overflow-hidden flex flex-col justify-between h-full p-4 hover:shadow-md transition-all duration-300">
                  ...
                  <div className="pt-4 flex-grow flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-base font-extrabold text-gray-900 dark:text-white mt-3 mb-2 leading-snug">
                        {course.title}
                      </h3>
                    ...
                    <div>
                      ...
                      <Link
                        to="/courses"
                        className="w-full text-center block text-xs font-semibold py-2 px-3 border border-indigo-600 dark:border-indigo-400 text-indigo-600 dark:text-indigo-400 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-950/20 transition-all"
                      >
                        View Syllabus & Enrol
                      </Link>
                    </div>
